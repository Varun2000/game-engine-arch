...
{
	public:
		GameObject(sf::Vector2f shape, sf::Vector2f position, sf::Texture* texture, sf::Color color);
		~GameObject();
        ...
        void updateObjShape(sf::Vector2f shape);

        void updateObjPosition(sf::Vector2f footPathOrigin);

        void updateObjTexture(sf::Texture* pathTexture);

        void moveObject(sf::Vector2f moveOffset);

        sf::FloatRect getObjGlobalBounds();
